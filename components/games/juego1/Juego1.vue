<template>
  <v-sheet color="green darken-1" dark min-height="100%" class="py-6 px-2">
    <v-container fluid>
      ...
      <v-row
        justify="center"
        class="juego-parejas__tablero mx-auto pa-1 pa-sm-5"
        ...
        >
          ...
          >
            <v-sheet
              color="red lighten-1"
              rounded
              class="juego-parejas__cara"
              aria-hidden="true"
            ></v-sheet>
            <v-sheet
              rounded
              dark
              class="juego-parejas__cara juego-parejas__trasera d-flex align-center justify-center font-weight-black"
              :style="{
...
export default {
  ...
  data() {
    return {
      dificultades: [
        { valor: '1', texto: 'Fácil', cantidad: 6, ancho: '500px' },
        { valor: '2', texto: 'Normal', cantidad: 12, ancho: '680px' },
...
.juego-parejas__tarjeta--girada .juego-parejas__cara:first-child {
  transform: rotateY(180deg);
}
